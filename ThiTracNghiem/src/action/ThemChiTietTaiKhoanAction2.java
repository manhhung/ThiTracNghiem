...
public class ThemChiTietTaiKhoanAction2 extends Action{
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		if("Xác nhận".equals(thongTinNguoiDungForm.getSubmit()))
		{
			...
			return mapping.findForward("suaThongTinTaiKhoanxong2");
		}
		else {		
			...
			return mapping.findForward("suaThongTinTaiKhoan2");
		}
	}
