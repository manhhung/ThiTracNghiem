...
<body>
<div class = "container">
		<html:form action="/themMon" method="post">
		<button class="btn btn-danger" onclick="history.go(-1);"><span class="glyphicon glyphicon-arrow-left"></span> Quay lại</button>
		<h3><b>Thêm Mới Môn Thi</b></h3>
		<br>
		<div class = "row form-group">
			<label class = "col-lg-2">Mã môn thi</label>
			<div class="col-lg-3">
            <html:text property="maMon" styleClass="form-control"></html:text>	
            <p style = "color:red"><bean:write name="monThiForm" property = "thongBaoMa"/></p>
