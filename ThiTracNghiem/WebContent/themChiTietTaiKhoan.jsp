...
<body>
<html:form action="/suaThongTinTaiKhoan" method="post" >
	<div class="container">
	...
	<h3>Thông tin chi tiết người dùng</h3>
		...
		<div class="col-lg-3">
					<html:text property="maNguoiDung" styleClass="form-control" maxlength="50" readonly="true"></html:text>
		...
		<label class="col-lg-2">Tên người dùng</label>
         <div class="col-lg-3">
				<html:text property="tenNguoiDung" styleClass="form-control" maxlength="50" ></html:text>
		</div>
		</div>
		<div class="row form-group">	
		<label class="col-lg-2">Giới tính</label>
          ...
          <div class="row form-group"> 
			<label class="col-lg-2">Ngày sinh</label>
			 <div class="col-lg-3">
				<html:text property="ngaySinh" styleClass="form-control" styleId="datepicker" maxlength="50"></html:text>
		</div>
			</div>
		...
		<div class="row form-group">	
			<label class="col-lg-2" >Địa chỉ</label>
			 <div class="col-lg-3">
				<html:text property="diaChi" styleClass="form-control" maxlength="100" ></html:text>
			...
			<label class="col-lg-2">Số điện thoại</label>
		       	 <div class="col-lg-3">
				<html:text property="soDienThoai" styleClass="form-control" maxlength="50"></html:text>
