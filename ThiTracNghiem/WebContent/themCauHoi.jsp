...
<div class="container">
    ...
    <br>
	<html:form action="/themCauHoi" method="post">
        ...
        <div class="row form-group">
            ...
            <div class="col-lg-3">
            	...
            	<span style="color: red;"><html:errors property="noiDungError"/></span>
            </div>
        </div>
        ...
        <div class="row form-group">
         ...
         <div class="row form-group">
            ...
            <div class="col-lg-3">
            	<html:select property="dapAnDung" value="dapAnDung" styleClass="form-control">
